...
- **Position** — uniform random over a centered rectangle whose area is ~38% of the full world (linear factor ~0.62 per axis), keeping stars clustered nearer the play corridor and away from the world edges. Rejection-sampled subject to (a) at least 10 star radii from Earth, (b) at least 5 star radii from the ship's spawn, (c) at least 4 star radii from any other star (numerical-stability floor for the N-body integrator).
